...
<?php include "templates/include/header.php" ?>
    ...
    <?php foreach ($results['articles'] as $article) {
        ...
        <li class='<?php echo $article->id?>'>
            ...
            <p class="summary"><?php echo htmlspecialchars($article->firstText)?></p>
            <img id="loader-identity" src="JS/ajax-loader.gif" alt="gif">
            <p class="hidden" data-contentId="<?php echo $article->id?>"> </p>
            ...
            <ul class="ajax-load">
                ...
                <li><a href=".?action=viewArticle&amp;articleId=<?php echo $article->id?>" class="postArticle" data-contentId="<?php echo $article->id?>">(POST) -- NEW</a></li>
                <li><a href=".?action=viewArticle&amp;articleId=<?php echo $article->id?>" class="getArticle" data-contentId="<?php echo $article->id?>">(GET)  -- NEW</a></li>
            </ul>
