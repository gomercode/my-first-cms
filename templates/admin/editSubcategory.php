...
<?php include "templates/admin/include/header.php" ?>
    ...
    <?php } ?>
        ...
        <ul>
          ...
          <li>
             <label for="category">Category of Subcategory</label>
                <select name="category">
                <?php foreach ( $results['categories'] as $category ) { ?>
                  <option value="<?php echo $category->id?>"<?php echo ( $category->id == $results['subcategory']->category ) ? " selected" : ""?>><?php echo htmlspecialchars( $category->name )?></option>
                <?php } ?>
                </select>
              </li>
        </ul>
